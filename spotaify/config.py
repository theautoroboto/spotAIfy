...
SETLISTFM_API_KEY     = _get_secret("SETLISTFM_API_KEY")
...
def history_dir_for(username: str) -> str:
    """Return the per-user history subdirectory path."""
    import os.path
    return os.path.join(HISTORY_DIR, username) if username else HISTORY_DIR
